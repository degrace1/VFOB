...
for request in range (1,10): # FIXME change this to be when u need it, like after servos are moving
    print ("Sending request ", request,"...")
    socket.send ("Plz give me location")
    #  Get the reply.
    message = socket.recv()
    print ("Received reply ", request, "[", message, "]") # FIXME add splitter for message
